...
HD_PWD='C:/Users/chris/4to1MuxDataflow/4to1MuxDataflow.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MuxDataflow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MuxDataflow.tcl
