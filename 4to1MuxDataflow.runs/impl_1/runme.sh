...
HD_PWD='C:/Users/chris/4to1MuxDataflow/4to1MuxDataflow.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MuxDataflow.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MuxDataflow.tcl -notrace
